...
def calculate_inverse():
    ...
    while r > 0:
        ...
        result_listbox.insert(tk.END, f'n0={n0}, b0={b0}, q={q}, r={r}, t0={t0}, t={t}, temp={temp}')
...
b_label = ttk.Label(main_frame, text="Introdu b:")
...
result_listbox = tk.Listbox(main_frame, width=50, height=10)
result_listbox.grid(row=3, column=0, columnspan=2, pady=5, sticky=tk.W)
